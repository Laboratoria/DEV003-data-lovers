...
Quiere: poder elegir una película para ver pero de forma aleatoria

Para: facilitar la búsqueda de una película animada, facilitando así su experiencia de usuario, no tardando en la búsqueda de una película que sea de su agrado

Definición de terminada: la usuaria al abrir la página web podrá visualizar acceder a un botón que al ser clickeado retornara una película de Studio Ghibli al azar.
...
Definición de terminado: el usuario al abrir la página web podrá acceder a un botón según la opción seleccionada retornara solo las películas de un director.
