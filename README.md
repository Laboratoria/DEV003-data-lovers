...
La interfaz poseer funcionalidades como filtros, selección y más que les permitirá tanto a principiantes como a maestros de Pokémon poder realizar investigación mas ágil.

## 2. Historia de usuario 1
Yo como fanático de Pokémon quiero poder entrar a la pagina y pode filtrar o encontrar de manera más fácil el tipo de elemento que pertenece a cada Pokémon. 
La funcionalidad se cumpliría al momento de entrar a la página en la primera pantalla estaría un botón donde podre filtrar de manera más rápida los tipos de Pokémon según su elemento y poder conocerlos.

 ##  Historia del usuario 2
 Yo como maestro Pokémon quisiera entrar a la interfaz y poder conocer el top 10 de frecuencia de aparición de los Pokémon. Para que de esta forma antes de salir a casar un Pokémon debo de saberlo.

 ##  Historia del usuario 3
Yo como usuario quisiera entrar a una interfaz y que me mostrara todos los Pokémon para q de esta forma yo pueda ver y seleccionar algún Pokémon que no conozca y poder ver todas sus características, para que esto me permita o facilite ir conociendo de apoco más de los Pokémon.
